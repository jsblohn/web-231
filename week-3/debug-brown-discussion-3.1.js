...
console.log(header.display('Janet', 'Blohn', 'Discussion 3.1 - Control Statements'));
...
for (index = 0; index < arr.length; index++) {  // initialized index to 0
  if (arr[index] === 'Fred'){
    console.log(`${arr[index]}, you are not registered. Please contact Bellevue to sign up.`);
  }else{
    console.log(`Hello ${arr[index]}, you are currently enrolled in Web-231!
    `);   // added [index] to print the name the array is currently pointing at
  }
}
